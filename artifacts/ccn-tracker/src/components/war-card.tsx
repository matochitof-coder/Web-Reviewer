...
export function WarCard({ war }: { war: CcnGuerraItem }) {
  ...
  return (
    <Card className={`relative overflow-hidden border-border/50 bg-card/40 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-card/60 ${isLive ? 'border-primary/30 shadow-[0_0_20px_rgba(0,210,255,0.05)]' : ''}`}>
